...
web build:
 - http://mootools.net/more/2e2f631da7faf1cd47f8ce3135254309

packager build:
 - packager build More/Class.Refactor More/Fx.Elements More/Fx.Scroll More/Drag.Move
...
return g;}:e);});return b;};Fx.Elements=new Class({Extends:Fx.CSS,initialize:function(b,a){this.elements=this.subject=$$(b);this.parent(a);},compute:function(g,h,j){var c={};
